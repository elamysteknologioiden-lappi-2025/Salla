...
namespace VRTK
{
    ...
    public abstract class VRTK_BasePointerRenderer : MonoBehaviour
    {
        ...
        protected Transform GetOrigin(bool smoothed = true)
        {
            // TODO : TAMA KUSEE
            return transform;
            Debug.LogError("smoothed" + smoothed);
            Debug.LogError("smoothed" + pointerOriginTransformFollow.gameObjectToChange.transform.position);
            //Debug.LogError("smoothed" +  controllingPointer.customOrigin.position );
            Debug.LogError("smoothed" + transform.position );
            //Debug.LogError("smoothed"  + controllingPointer.customOrigin.position);
            return smoothed
        ...
        protected virtual void CreatePointerOriginTransformFollow()
        {
           ...
           // Debug.LogError("pointerOriginTransformFollow" + pointerOriginTransformFollow.gameObjectToFollow.transform.position);
