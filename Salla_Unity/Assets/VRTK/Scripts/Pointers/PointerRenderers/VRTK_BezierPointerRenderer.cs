...
namespace VRTK
{
    ...
    public class VRTK_BezierPointerRenderer : VRTK_BasePointerRenderer
    {
        ...
        {
          //  Debug.LogError("CreatePointerObjects");
        ...
        {
          //  Debug.LogError("DestroyPointerObjects");
        ...
        {
           // Debug.LogError("UpdateObjectInteractor");
        ...
        protected virtual GameObject CreateCursorObject() {
          //  Debug.LogError("CreateCursorObject");
        ...
        {
          //  Debug.LogError("CreateCursorLocations");
        ...
        {
           // Debug.LogError("ProjectForwardBeam");
...
#pragma warning restore 0618
           // Debug.LogError("hasRayHit"+ hasRayHit);
            ...
            if (hasRayHit)
            {
                ...
                //Debug.LogError("hasRayHit " + contactDistance);
            }

            //adjust beam length if something is blocking it
            if (hasRayHit && contactDistance < calculatedLength)
            {
              //  Debug.LogError("contactDistance "+ contactDistance);
  
                  actualLength = contactDistance;
            }
           // Debug.LogError("pointerRaycast " + pointerRaycast.GetPoint(actualLength - BEAM_ADJUST_OFFSET) + "  ...  "+ actualLength);
        ...
        protected virtual Vector3 ProjectDownBeam(Vector3 jointPosition) {
            //Debug.LogError("ProjectDownBeam " + jointPosition + "  ...  ");
...
#pragma warning restore 0618
        ...
        // Debug.LogError("AdjustForEarlyCollisions");
...
#pragma warning restore 0618
        ...
        {
           // Debug.LogError("DisplayCurvedBeam");
            if (actualTracer != null)
            {
                Vector3[] beamPoints = new Vector3[]
                {
        ...
        protected virtual void TogglePointerCursor(bool pointerState, bool actualState) {
            //Debug.LogError("TogglePointerCursor");
        ...
        {
            //Debug.LogError("TogglePointerTracer");
        ...
        protected virtual void SetPointerCursor() {
           // Debug.LogError("SetPointerCursor");
